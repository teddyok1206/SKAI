...
- i18n source regression gate는 생겼지만, `scripts/i18n_source_baseline.json`에 남아 있는 raw JSX/attribute text는 아직 줄여야 한다.
...
- 다음 구현: playbook locale variant와 raw JSX baseline reduction을 분리해서 진행한다.
