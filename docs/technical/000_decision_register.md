...
| TDR-081 | Generated problem editorial gate | Generated problems are hidden from first-smoke discovery until founder checklist approval publishes them | Superseded | Superseded by TDR-094 for batch 001: initial synthetic problem risk was valid, but current generated corpus is now audited and automatically checked; the gate remains useful for future batches, not for hiding confirmed corpus | 2026-06-02 |
